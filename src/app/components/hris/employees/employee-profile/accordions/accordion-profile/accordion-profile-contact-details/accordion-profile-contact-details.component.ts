...
export class AccordionProfileContactDetailsComponent {
  ...
  initializeForm() {
    this.sharedAccordionFunctionality.employeeContactForm = this.fb.group({
      ...
      cellphoneNo: [this.employeeProfile.employeeDetails.cellphoneNo, [Validators.required, Validators.maxLength(13), Validators.pattern(/^(\+[1-9][0-9][6-8][0-9]{8})|([0][6-8][0-9]{8})$/)]],
      houseNo: [this.employeeProfile.employeeDetails.houseNo, [Validators.maxLength(13), Validators.pattern(/^(\+[1-9][0-9][6-8][0-9]{8})|([0][6-8][0-9]{8})$/)]],
      ...
      emergencyContactNo: [this.employeeProfile.employeeDetails.emergencyContactNo, [Validators.required, Validators.pattern(/^(\+[1-9][0-9][6-8][0-9]{8})|([0][6-8][0-9]{8})$/), Validators.maxLength(13)]]
    });
