...
import { MentorpersonalprojectPageComponent } from './components/mentorpersonalproject-page/mentorpersonalproject-page.component';
...
@NgModule({
  declarations: [
    ...
    MentorpersonalprojectPageComponent,
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
